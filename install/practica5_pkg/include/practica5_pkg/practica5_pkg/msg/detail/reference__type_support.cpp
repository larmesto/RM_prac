...
{
  new (message_memory) practica5_pkg::msg::Reference(_init);
}

void Reference_fini_function(void * message_memory)
{
  auto typed_message = static_cast<practica5_pkg::msg::Reference *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Reference_message_member_array[3] = {
  {
    ...
    offsetof(practica5_pkg::msg::Reference, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(practica5_pkg::msg::Reference, pose),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(practica5_pkg::msg::Reference, velocity),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Reference_message_members = {
  "practica5_pkg::msg",  // message namespace
  "Reference",  // message name
  3,  // number of fields
  sizeof(practica5_pkg::msg::Reference),
...
get_message_type_support_handle<practica5_pkg::msg::Reference>()
{
  return &::practica5_pkg::msg::rosidl_typesupport_introspection_cpp::Reference_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, practica5_pkg, msg, Reference)() {
  return &::practica5_pkg::msg::rosidl_typesupport_introspection_cpp::Reference_message_type_support_handle;
}
