...
bool kinematic_control_pkg__msg__reference__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("kinematic_control_pkg.msg._reference.Reference", full_classname_dest, 46) == 0);
  }
  kinematic_control_pkg__msg__Reference * ros_message = _ros_message;
  {  // header
...
PyObject * kinematic_control_pkg__msg__reference__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("kinematic_control_pkg.msg._reference");
