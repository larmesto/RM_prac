...
def generate_launch_description():
    ...
    rviz_dir = LaunchConfiguration(
        ...
        default=os.path.join(
            get_package_share_directory('kinematic_control_pkg'), 'launch'))
    ...
    kinematic_control_cmd_group = GroupAction(actions)

    ld = LaunchDescription()
    ld.add_action(kinematic_control_cmd_group)
