...
def generate_launch_description():
    ...
    rviz_dir = LaunchConfiguration(
        ...
        default=os.path.join(
            get_package_share_directory('ros2_vfh'), 'launch'))
    ...
    # Condition
    # -------------------------
    use_amcl_condition = IfCondition(
        PythonExpression([use_amcl, " == 'True'"])
    )

    use_not_amcl_condition = IfCondition(
    PythonExpression([use_amcl, " == 'False'"])
    )
    ...
    vfh_cmd = GroupAction([
        ...
        IncludeLaunchDescription(
            ...
            condition=use_not_amcl_condition
        ),
