...
#include "kinematic_control_pkg/msg/detail/reference__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = kinematic_control_pkg::msg::Reference;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const kinematic_control_pkg::msg::Reference *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<kinematic_control_pkg::msg::Reference *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_kinematic_control_pkg
const rosidl_message_type_support_t *
get_message_type_support_handle<kinematic_control_pkg::msg::Reference>()
{
  return &kinematic_control_pkg::msg::typesupport_fastrtps_cpp::_Reference__handle;
}
