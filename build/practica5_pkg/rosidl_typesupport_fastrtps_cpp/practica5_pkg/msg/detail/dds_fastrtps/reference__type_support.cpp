...
#include "practica5_pkg/msg/detail/reference__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = practica5_pkg::msg::Reference;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const practica5_pkg::msg::Reference *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<practica5_pkg::msg::Reference *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_practica5_pkg
const rosidl_message_type_support_t *
get_message_type_support_handle<practica5_pkg::msg::Reference>()
{
  return &practica5_pkg::msg::typesupport_fastrtps_cpp::_Reference__handle;
}
