...
static const _ResetOdom_Request_type_support_symbol_names_t _ResetOdom_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_laser_scan_matcher, srv, ResetOdom_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_laser_scan_matcher, srv, ResetOdom_Request)),
  }
};
...
{
  return &::ros2_laser_scan_matcher::srv::rosidl_typesupport_cpp::ResetOdom_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2_laser_scan_matcher, srv, ResetOdom_Request)() {
  return get_message_type_support_handle<ros2_laser_scan_matcher::srv::ResetOdom_Request>();
}
...
static const _ResetOdom_Response_type_support_symbol_names_t _ResetOdom_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_laser_scan_matcher, srv, ResetOdom_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_laser_scan_matcher, srv, ResetOdom_Response)),
  }
};
...
{
  return &::ros2_laser_scan_matcher::srv::rosidl_typesupport_cpp::ResetOdom_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2_laser_scan_matcher, srv, ResetOdom_Response)() {
  return get_message_type_support_handle<ros2_laser_scan_matcher::srv::ResetOdom_Response>();
}
...
static const _ResetOdom_type_support_symbol_names_t _ResetOdom_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_laser_scan_matcher, srv, ResetOdom)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_laser_scan_matcher, srv, ResetOdom)),
  }
};
...
{
  return &::ros2_laser_scan_matcher::srv::rosidl_typesupport_cpp::ResetOdom_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2_laser_scan_matcher, srv, ResetOdom)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<ros2_laser_scan_matcher::srv::ResetOdom>();
}
