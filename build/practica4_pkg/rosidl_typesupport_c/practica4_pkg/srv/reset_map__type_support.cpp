...
static const _ResetMap_Request_type_support_symbol_names_t _ResetMap_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, practica4_pkg, srv, ResetMap_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, practica4_pkg, srv, ResetMap_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, practica4_pkg, srv, ResetMap_Request)() {
  return &::practica4_pkg::srv::rosidl_typesupport_c::ResetMap_Request_message_type_support_handle;
}
...
static const _ResetMap_Response_type_support_symbol_names_t _ResetMap_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, practica4_pkg, srv, ResetMap_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, practica4_pkg, srv, ResetMap_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, practica4_pkg, srv, ResetMap_Response)() {
  return &::practica4_pkg::srv::rosidl_typesupport_c::ResetMap_Response_message_type_support_handle;
}
...
static const _ResetMap_type_support_symbol_names_t _ResetMap_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, practica4_pkg, srv, ResetMap)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, practica4_pkg, srv, ResetMap)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, practica4_pkg, srv, ResetMap)() {
  return &::practica4_pkg::srv::rosidl_typesupport_c::ResetMap_service_type_support_handle;
}
