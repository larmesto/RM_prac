...
static const _ResetMap_Request_type_support_symbol_names_t _ResetMap_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, practica4_pkg, srv, ResetMap_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, practica4_pkg, srv, ResetMap_Request)),
  }
};
...
{
  return &::practica4_pkg::srv::rosidl_typesupport_cpp::ResetMap_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, practica4_pkg, srv, ResetMap_Request)() {
  return get_message_type_support_handle<practica4_pkg::srv::ResetMap_Request>();
}
...
static const _ResetMap_Response_type_support_symbol_names_t _ResetMap_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, practica4_pkg, srv, ResetMap_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, practica4_pkg, srv, ResetMap_Response)),
  }
};
...
{
  return &::practica4_pkg::srv::rosidl_typesupport_cpp::ResetMap_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, practica4_pkg, srv, ResetMap_Response)() {
  return get_message_type_support_handle<practica4_pkg::srv::ResetMap_Response>();
}
...
static const _ResetMap_type_support_symbol_names_t _ResetMap_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, practica4_pkg, srv, ResetMap)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, practica4_pkg, srv, ResetMap)),
  }
};
...
{
  return &::practica4_pkg::srv::rosidl_typesupport_cpp::ResetMap_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, practica4_pkg, srv, ResetMap)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<practica4_pkg::srv::ResetMap>();
}
