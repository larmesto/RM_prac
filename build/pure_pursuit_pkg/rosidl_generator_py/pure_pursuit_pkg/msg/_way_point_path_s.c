...
bool pure_pursuit_pkg__msg__way_point_path__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pure_pursuit_pkg.msg._way_point_path.WayPointPath", full_classname_dest, 49) == 0);
  }
  pure_pursuit_pkg__msg__WayPointPath * ros_message = _ros_message;
  {  // closed_path
    PyObject * field = PyObject_GetAttrString(_pymsg, "closed_path");
    if (!field) {
      return false;
    }
    if (!std_msgs__msg__bool__convert_from_py(field, &ros_message->closed_path)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * pure_pursuit_pkg__msg__way_point_path__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("pure_pursuit_pkg.msg._way_point_path");
  ...
  {  // closed_path
    PyObject * field = NULL;
    field = std_msgs__msg__bool__convert_to_py(&ros_message->closed_path);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "closed_path", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
