...
class ReferenceNode : public rclcpp::Node
{
    ...
    ReferenceNode() : Node("reference_node")
    {
        ...
        // Publicador
        ref_pub = this->create_publisher<kinematic_control_pkg::msg::Reference>("reference", 10);
    ...
    void publish_reference(double x, double y, double theta, double xp, double yp, double thetap)
    {
        ...
        kinematic_control_pkg::msg::Reference ref_msg;
    ...
    rclcpp::Publisher<kinematic_control_pkg::msg::Reference>::SharedPtr ref_pub;
