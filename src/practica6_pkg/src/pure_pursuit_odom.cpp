...
public: PurePursuitOdom() : Node("pure_pursuit")
{
    ...
    waypoint_subs = this->create_subscription<practica6_pkg::msg::WayPointPath>(
...
private:
	...
	void path_marker(practica6_pkg::msg::WayPointPath path)
    {
...
rclcpp::Subscription<practica6_pkg::msg::WayPointPath>::SharedPtr waypoint_subs;
