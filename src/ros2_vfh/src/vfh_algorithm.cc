      ...
      last_chosen_speed(0)
{
	...
	//std::cout << "NUM_CELL_SECTOR_TABLES " << NUM_CELL_SECTOR_TABLES << std::endl;
	//std::cout << "Current_Max_Speed " << Current_Max_Speed << std::endl;
	//std::cout << "Binary_Hist_High_0ms: " << Binary_Hist_High_0ms << std::endl;
	//std::cout << "Binary_Hist_Low_0ms: " << Binary_Hist_Low_0ms << std::endl;
	//std::cout << "Binary_Hist_High_1ms: " << Binary_Hist_High_1ms << std::endl;
	//std::cout << "Binary_Hist_Low_1ms: " << Binary_Hist_Low_1ms << std::endl;
}
 ...
 * @return 1
 */
int VFH_Algorithm::Update_VFH( double laser_ranges[360],
                               int current_speed,
...
//  assert( GlobalTime->GetTime( &now ) == 0 );
  ...
  //std::cout << "Update_VFH: Build_Primary_Polar_Histogram" << std::endl;
  ...
  //std::cout << "Picked Angle: " << Picked_Angle << std::endl;
...
void VFH_Algorithm::Print_Hist()
{
  ...
  for(x=0;x<=(HIST_SIZE/2);x++) {
    std::cout << (x * SECTOR_ANGLE) << "," << Hist[x] << std::endl;
  }
  std::cout << std::endl;
}
 ...
 * @return 1
 */
int VFH_Algorithm::Calculate_Cells_Mag( double laser_ranges[360], int speed )
{
  int x, y;
...
//    	                      laser_ranges[(int)rint(Cell_Direction[x][y] * 2.0)],
 ...
 * @return 1
 */
int VFH_Algorithm::Build_Primary_Polar_Histogram( double laser_ranges[360], int speed )
{
  int x, y;
  unsigned int i;
  ...
  //std::cout << "Build_Primary_Polar_Histogram: speed speed_index " << speed << " " << speed_index << " " << HIST_SIZE << std::endl;
...
int VFH_Algorithm::Build_Binary_Polar_Histogram( int speed )
{
  ...
  //std::cout << "High: " << Get_Binary_Hist_High(speed) << " Low: " << Get_Binary_Hist_Low(speed) << std::endl;
  for(x=0;x<HIST_SIZE;x++) {
